 ...
 * * `dev.bpm-crafters.process-api.adapter.cib7embedded.user-tasks.execute-initial-pull-on-startup` is true
 */
open class Cib7EmbeddedAdapterUserTaskInitialPullEnabledCondition : Cib7EmbeddedAdapterEnabledCondition() {
