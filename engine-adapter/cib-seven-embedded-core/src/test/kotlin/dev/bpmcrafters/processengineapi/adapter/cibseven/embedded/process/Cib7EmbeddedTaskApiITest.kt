...
class Cib7EmbeddedTaskApiITest : AbstractCib7EmbeddedApiITest(Cib7EmbeddedProcessTestHelper(engine.processEngine)) {

  companion object {
    @RegisterExtension
    val engine: ProcessEngineExtension = ProcessEngineExtension.builder().useProcessEngine(processEngine).build()
  }
